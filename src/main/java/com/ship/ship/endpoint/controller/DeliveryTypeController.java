...
public class DeliveryTypeController {
    ...
    public List<DeliveryType> saveDeliveryTypees(@RequestBody List<DeliveryType> deliveryTypees){
        ...
        deliveryTypees.forEach(deliveryType -> {
    ...
    @PutMapping(value = "/{id}")
    public DeliveryType updateDeliveryType(@PathVariable Integer id, @RequestBody DeliveryType deliveryType){
        String msg = String.format("The DeliveryType Id %s is different from the Url Id",deliveryType.getId());
