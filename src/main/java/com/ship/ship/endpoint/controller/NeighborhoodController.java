...
public class NeighborhoodController {
    ...
    @PutMapping(value = "/{id}")
    public Neighborhood updateNeighborhood(@PathVariable Integer id, @RequestBody Neighborhood neighborhood){
        String msg = String.format("The Neighborhood Id %s is different from the Url Id",neighborhood.getId());
