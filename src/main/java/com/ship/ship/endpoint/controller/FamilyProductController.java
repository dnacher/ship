...
public class FamilyProductController {
  ...
  public FamilyProduct updateFamilyProduct(
      @PathVariable Integer id, @RequestBody FamilyProduct familyProduct) {
    String msg =
        String.format(
            "The FamilyProduct Id %s is different from the Url Id", familyProduct.getId());
